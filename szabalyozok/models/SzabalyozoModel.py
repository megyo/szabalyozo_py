...
class Atadok(models.Model):
    atado = models.CharField(max_length=100, blank=False, null=False)
...
class Megyek(models.Model):
    megye = models.CharField(max_length=100, blank=False, null=False)
...
class Uzemek(models.Model):
    uzem = models.CharField(max_length=100, blank=False, null=False)
...
class Telepulesek(models.Model):
    telepules = models.CharField(max_length=100, blank=False, null=False)
...
class Tartozekgyartok(models.Model):
    tartozekgyarto = models.CharField(max_length=100, blank=False, null=False)
...
class SzabKarb(models.Model):
    szabkarb = models.CharField(max_length=100, blank=True, null=True)
...
class Szabalyozok(models.Model):
    ...
    VILLAMVEDELEM_CHOICES = (
        ('', 'Kérem válasszon'),
        ('norma', 'Norma szerinti'),
        ('nem_norma', 'Nem norma szerinti'),
    )
